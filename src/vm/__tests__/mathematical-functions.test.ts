  ...
  describe('Absolute Value Function (abs)', () => {
    ...
    describe('Error Handling', () => {
      it('should handle empty stack', () => {
        ...
        expect(() => vm.execute(instructions)).toThrow(/cannot execute abs from empty stack/i);
      });
  ...
  describe('Square Root Function (sqrt)', () => {
    ...
    describe('Error Handling', () => {
      it('should handle negative numbers', () => {
        ...
        expect(() => vm.execute(instructions)).toThrow(RuntimeError);
        expect(() => vm.execute(instructions)).toThrow(/cannot take square root of negative number/i);
      });
  ...
  describe('Power Function (pow)', () => {
    ...
    describe('Error Handling', () => {
      it('should handle zero to negative power', () => {
        ...
        expect(() => vm.execute(instructions)).toThrow(RuntimeError);
        expect(() => vm.execute(instructions)).toThrow(/cannot raise 0 to negative power/i);
      });
  ...
  describe('Performance and Edge Cases', () => {
    ...
    it('should handle edge case numbers', () => {
      const testCases = [
        ...
        { func: 'sqrt', input: Number.MIN_VALUE, expected: Math.sqrt(Number.MIN_VALUE) },
        { func: 'abs', input: -Number.EPSILON, expected: Number.EPSILON }
      ];
